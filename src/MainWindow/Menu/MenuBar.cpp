...
void MenuBar::connectSignals()
{
	connect(m_aboutAction, &QAction::triggered, this, [this]()
	{
		...
		auto version = QLabel(
			"<a href=\"https://github.com/Sudo-Rahman/Iridium/releases/tag/v" + QString::fromStdString(VERSION) +
			"\">" + QString::fromStdString(VERSION) + "</a>");
		version.setOpenExternalLinks(true);
		formLayout.addRow(new QLabel(tr("Version : ")), &version);
